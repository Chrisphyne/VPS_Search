...
console.log("🔍 Meilisearch Host:", process.env.VITE_MEILISEARCH_HOST);
console.log("🗄️ PostgreSQL Host:", process.env.VITE_PG_HOST);
        ...
        try {
            if (meiliClient) {
                const response = await fetch(
                    `${process.env.VITE_MEILISEARCH_HOST}/health`,
                );
