        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900">
                Kenya Police Search System
              </h1>
              <p className="text-sm text-gray-500">Criminal Investigation Database</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 px-3 py-2 bg-blue-50 rounded-md">
              ...
              <span className="text-sm font-medium text-blue-900">Search Portal</span>
            </div>
          </div>
        </div>
      </div>
