...
# Re-initialize query builder with fixed column name
query_builder = JSONBQueryBuilder(db, schema_manager)
print("✅ JSONB Query Builder (FIXED) initialized!")

# Test the query builder
print("\nTesting Fixed Query Builder:")
print("=" * 40)
